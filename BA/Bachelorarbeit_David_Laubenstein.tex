...
\include{src/statement}  % Einleitung
\include{src/introduction}  % Einleitung
\include{src/background}  % Grundlagen
\include{src/analysis}     % Analyse
\include{src/design}     % Entwurf
\include{src/implementation}    % Implementierung
\include{src/evaluation}        % Evaluierung
\include{src/futurework}  % Future Work
\include{src/summary}   % Zusammenfassung und Ausblick
\include{src/anhang}   % Anhang
