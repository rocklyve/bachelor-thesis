...
Aus dem Datensatz werden hierbei Features berechnet, welche dann ein wichtiger Teil der Klassifikation sind.
...
Ein vielversprechender Ansatz ist es, mittels IMU-Daten die Bewegung des Körpers zu messen und anhand dieser Informationen unter anderem die Atmung herauszufiltern, um dann Rückschlüsse auf Schlafstörungen folgern zu können.
...
Im Bereich von [0.3,0.6] Hz zeigt sich das Maximum der spektralen Leistung.
...
Der Gyroskop- und Beschleunigungssensor ist an der rechten Seite angebracht, ebenso wie eine Kamera, einen Magnetometer, einen Lightsensor und ein Mikrofon. 
