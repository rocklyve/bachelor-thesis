...
\todo{wie wurden die Daten herausgezogen und wie liegen sie zum aktuellen zeitpunkt vor}
\todo{Dies war zu beachten, weil ich erfahren habe, dass der Timer nicht genau nach der richtigen uhrzeit läuft}
\todo{die Verschiebung der Peaks waren dann allerdings nur 0,2sec innerhalb von 7 Minuten... Verschiebung um den mittelwert reicht fürs erste, macht bei der Klassifikation keinen unterschied}
