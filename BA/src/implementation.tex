...
\begin{figure}[ht]
  ...
  \begin{subfigure}{0.66\textwidth}
    ...
    \caption{Peaks des Lichtsignals vom PSG-Gerät \todo{bessere grafik und zudem noch dass man alle peaks von der edf sieht und die doppelten signale erkennt, eventuell breitere grafik}}
  ...
  \begin{subfigure}{.49\textwidth}
    ...
    \caption{Zeitlicher Lichtpeakvergleich vor der Synchronisation}
  ...
  \begin{subfigure}{.49\textwidth}
    ...
    \caption{Zeitlicher Lichtpeakvergleich nach der Synchronisation}
