...
\savebox{\Zweitgutachter}{\usesf Franziska Mathis-Ullrich}
...
\vfill
{\usesf
{\huge\bfseries Klassifikation von respiratorischen Ereignissen mit Earables und maschinellem Lernen
 \par}
\vskip 1.8cm
Bachelor Thesis\\
von\\[2mm]
...
\end{tabular}
\vskip 3cm
Project Period:\qquad 01/11/2019 -- 10/04/2020
}
\end{center}
\vfill
\end{titlepage}
